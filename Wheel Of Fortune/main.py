...
def write(color, whatToWrite, center=(0, 0), toWrite=(0, 0)):
    circle.penup()
    circle.goto(toWrite)
    circle.pendown()
    circle.color(color)
...
write('white', results[0][0], center=(25, 50), toWrite=(30, 260))
write('white', results[0][1], center=(25, 50), toWrite=(-19, 260))
write('white', results[0][2], center=(25, 50), toWrite=(-80, 250))
write('white', results[0][3], center=(25, 50), toWrite=(-135, 220))
write('white', results[0][4], center=(25, 50), toWrite=(-170, 180))
write('white', results[0][5], center=(25, 50), toWrite=(-200, 130))
write('white', results[0][6], center=(25, 50), toWrite=(-215, 65))
write('white', results[0][7], center=(25, 50), toWrite=(-215, 15))
write('white', results[0][8], center=(25, 50), toWrite=(-200, -40))
write('white', results[0][9], center=(25, 50), toWrite=(-170, -90))
write('white', results[0][10], center=(25, 50), toWrite=(-130, -135))
write('white', results[0][11], center=(25, 50), toWrite=(-80, -175))
write('white', results[0][12], center=(25, 50), toWrite=(-30, -190))
write('white', results[0][13], center=(25, 50), toWrite=(35, -190))
write('white', results[0][14], center=(25, 50), toWrite=(90, -170))
write('white', results[0][15], center=(25, 50), toWrite=(140, -140))
write('white', results[0][16], center=(25, 50), toWrite=(170, -95))
write('white', results[0][17], center=(25, 50), toWrite=(210, -50))
